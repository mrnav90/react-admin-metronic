...
(function ($) {
    ...
    $.fn.mExample = function (options) {
        ...
        var Plugin = {
             ...
             */
            eventTrigger: function(name) {
                for (var i = 0; i < example.events.length; i++) {
...
(function ($) {
    ...
    $.fn.mMessenger = function (options) {
        ...
        var Plugin = {
             ...
             */
            eventTrigger: function(name) {
                for (var i = 0; i < messenger.events.length; i++) {
...
(function($) {
    ...
    $.fn.mOffcanvas = function(options) {
        ...
        var Plugin = {
             ...
             */
            eventTrigger: function(name) {
                for (var i = 0; i < offcanvas.events.length; i++) {
...
(function ($) {
    ...
    $.fn.mPortlet = function (options) {
        ...
        var Plugin = {
             ...
             */
            eventTrigger: function(name) {
                for (var i = 0; i < portlet.events.length; i++) {
...
(function($) {
    ...
    $.fn.mScrollTop = function(options) {
        ...
        var Plugin = {
             ...
             */
            eventTrigger: function(name) {
                for (var i = 0; i < scrollTop.events.length; i++) {
...
(function($) {
    ...
    $.fn.mWizard = function(options) {
        ...
        var Plugin = {
             ...
             */
            eventTrigger: function(name) {
                for (var i = 0; i < wizard.events.length; i++) {
